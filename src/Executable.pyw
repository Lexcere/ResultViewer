...
class Application(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.active_filter_text.SetToolTipString(str(self.active_filter))
    ...
    def DrawGUI(self):
        ...
        self.retrieve_data_from_folder.SetToolTipString("Source folder for data")
        ...
        self.result_store_folder.SetToolTipString("Choose the folder to store the results")
    ...
    def DrawMenuBar(self):
        ...
        fileMenu.AppendItem(read_data)
        fileMenu.AppendItem(self.recursive)
        fileMenu.AppendItem(reset_folder)
        fileMenu.AppendSeparator()
        fileMenu.AppendItem(save_data)
        filtersMenu.AppendItem(reset_all_filters)
        filtersMenu.AppendItem(self.case_sensitive_check)
        filtersMenu.AppendSeparator()
        filtersMenu.AppendItem(set_today)
        filtersMenu.AppendItem(set_this_pc)
        filtersMenu.AppendItem(set_hil1)
        filtersMenu.AppendItem(set_hil2)
        filtersMenu.AppendItem(set_hil3)

        reportMenu.AppendMenu(wx.ID_ANY, 'HTML', html_submenu)
        reportMenu.AppendMenu(wx.ID_ANY, 'Excel', excel_submenu)

        html_submenu.AppendItem(html_report_info)
        html_submenu.AppendItem(html_report_other_restriction)
        html_submenu.AppendItem(new_deviation)
        html_submenu.AppendSeparator()
        html_submenu.AppendItem(generate_report_html)
        excel_submenu.AppendItem(open_summary)
        excel_submenu.AppendItem(generate_report)
        excel_submenu.AppendItem(self.selected_reports["overview"])
        excel_submenu.AppendItem(self.selected_reports["trace"])
        excel_submenu.AppendItem(self.selected_reports["incident"])
        excel_submenu.AppendItem(self.selected_reports["details"])

        windowsMenu.AppendItem(self.metric_panel_visibility)
        windowsMenu.AppendItem(self.message_panel_visibility)
        helpMenu.AppendItem(manual)
        helpMenu.AppendItem(report_problem)
        helpMenu.AppendItem(view_log_file)
