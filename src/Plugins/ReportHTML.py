...
class ReportHTML():
    ...
    def WriteStyleSheet(self):
        ...
        self.report.write('    border-style: none;\n')
        self.report.write('    text-align:center;\n')
        self.report.write('    width:50%;\n')
        self.report.write('    padding: 5px;\n')
        self.report.write('    font-size: 20px;\n')
        self.report.write('    font-weight: normal;\n')
        self.report.write('}\n')
        self.report.write('.header_table_statistic  td{\n')
        self.report.write('    border-top: none;\n')
        self.report.write('    border-left: none;\n')
        self.report.write('    border-right: none;\n')
        self.report.write('    text-align:center;\n')
        self.report.write('    padding: 5px;\n')
        self.report.write('    font-size: 14px;\n')
        self.report.write('}\n')
